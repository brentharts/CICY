...
\title{Supplementary material: figures for the \emph{Extended} \pkg{pyCICY} package}
...
The same points, separated by whether the configuration matrix
...
\begin{minipage}[c]{0.5\textwidth}
\centering
  \includegraphics[width=0.4\textwidth]{quintic_surface.png}
  \label{fig:quintic}
\end{minipage}
...
\begin{minipage}[c]{0.55\textwidth}
\centering
  \includegraphics[width=0.7\textwidth]{node_counts}
  \label{fig:nodes}
\end{minipage}
...
\begin{minipage}[c]{0.5\textwidth}
\centering
  \includegraphics[width=0.7\textwidth]{gv_invariants}
  \label{fig:gv}
\end{minipage}
