...
space $\PP^{2,3,1}$ \cite{Vafa1996, MorrisonVafaI, MorrisonVafaII}, 
which is not a product of projective spaces, so it has no
...
string spectrum follows from how $\sigma$ splits the cohomology \cite{BKLS2007, CollinucciDenefEsole2009}. Here the
